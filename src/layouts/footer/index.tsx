  ...
  return (
    <footer className="h-[35px] max-h-[35px] sm:max-h-[40px] sm:h-[40px] flex items-center justify-between w-full bg-secondary border-t border-borderColor">
      <div className="flex items-center px-2.5">
        ...
        <p>&nbsp;&nbsp;&nbsp;</p>
        <a href="https://x.com/mondx_xyz" target="_blank">
        <p className="text-font-60 text-xs whitespace-nowrap">Twitter</p>
        </a>
        <p>&nbsp;&nbsp;&nbsp;</p>
        <a href="https://t.me/mondx_xyz" target="_blank">
        <p className="text-font-60 text-xs whitespace-nowrap">Telegram</p>
        </a>
